...
- Hash URL: `https://[hash].pedicab512.pages.dev`
- Branch alias: `https://feature-[branch-name].pedicab512.pages.dev`

### Step 3: Run E2E Tests Against Deployment

**Standard pattern (always use deployed URL):**
```bash
SEND_TEST_EMAILS=true PLAYWRIGHT_BASE_URL=https://feature-branch.pedicab512.pages.dev npm run test -- test-name
```
...
SEND_TEST_EMAILS=true PLAYWRIGHT_BASE_URL=https://feature-branch.pedicab512.pages.dev npm run test -- backroom-team-chat
```
...
SEND_TEST_EMAILS=true PLAYWRIGHT_BASE_URL=https://feature-xyz.pedicab512.pages.dev npm run test -- test-name

# Validation test (check email system works)
SEND_TEST_EMAILS=true PLAYWRIGHT_BASE_URL=https://pedicab512.pages.dev npm run test -- test-email-report
